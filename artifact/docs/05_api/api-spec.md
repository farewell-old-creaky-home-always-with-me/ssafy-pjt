...
**오류 케이스**
- 400: 유형, 이름, 주소, 좌표, 행정구역 코드 오류
- 401: 미인증
- 409: HOME/WORK 중복 또는 OTHER 5개 초과

---

### PUT /api/places/{placeId} — 내 장소 수정
...
- 403: 본인 장소가 아님
- 404: 장소 없음
- 409: 변경 후 HOME/WORK 중복 또는 OTHER 5개 초과

---

### DELETE /api/places/{placeId} — 내 장소 삭제
