...
CREATE TABLE IF NOT EXISTS house (
    ...
    UNIQUE KEY uq_house_identity (region_code, apt_name, jibun)
...
-- ============================================================
-- 상권 정보 (공공 데이터 배치 수집 또는 실시간 캐시 — 미정)
-- ============================================================
CREATE TABLE IF NOT EXISTS commercial_area (
    ...
    -- 위치 기반 조회 최적화: Spatial Index 검토 필요 (미정)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='상권 정보';

-- ============================================================
-- 환경 정보 (서울 열린데이터 — 서울 지역 한정)
-- ============================================================
